...
public class MainCanteen {
    public static void main(String[] args) {
        ...
        double avgRatings = computeAvgRatings(products);
    ...
    public static double computeAvgRatings(List<CanteenProduct> products) {
        ...
        for (CanteenProduct product : products) {
            if (product instanceof Ratable) {
                Ratable ratableProduct = (Ratable) product;
                totalRatings += ratableProduct.getAvgRating();
                numProducts++;
            }
        }
        ...
        return (double) totalRatings / numProducts;
    }
...
>>>>>>> 15938cb62b5eef848a0f8d7cd00ba1e47909097c
